...
const TabElement = observer((props) => {
    return (<div key={props.tab_key} className="tab" onClick={() => { store.setCurrentTabId(props.tab_key); }}>
            {props.name}
        </div>);
});
const ExplorerTabList = observer((props) => {
    return (<div className="explorer__tab-list">
...
const Exlorer = observer(() => {
    ...
    // }
    // const width = '100px'
    return (<div className="explorer" style={resize_store.explorerStyle}>
